...
|---|---|---|---|
| Claude Code | Plugin | `.claude-plugin/plugin.json`, `skills/`, `commands/` | `/plugin marketplace add hSenidMobileCPaaS/Applink-as-a-Skill` |
| Claude Agent SDK | Skills | `SKILL.md`, `skills/` | Point the SDK at the checkout |
| Codex CLI / desktop | Plugin | `.codex-plugin/plugin.json`, `skills/` | `codex plugin marketplace add hSenidMobileCPaaS/Applink-as-a-Skill` |
| GitHub Copilot CLI | Plugin | `.claude-plugin/`, `.github/copilot-instructions.md` | `copilot plugin marketplace add hSenidMobileCPaaS/Applink-as-a-Skill` |
| Gemini CLI / Antigravity | Plugin | `gemini-extension.json` → `AGENTS.md` | `gemini extensions install https://github.com/hSenidMobileCPaaS/Applink-as-a-Skill` |
| Qoder | Plugin | `.qoder-plugin/plugin.json`, `.qoder/rules/` | Copy `.qoder/rules/applink.md` |
| Hermes Agent | Plugin | `plugin.yaml`, `skills/`, `commands/` | `hermes plugins install hSenidMobileCPaaS/Applink-as-a-Skill` |
| OpenCode | Context | `opencode.json` → `AGENTS.md` | Auto-loads `AGENTS.md` from the project root |
| Cursor | Rules | `.cursor/rules/applink.mdc` | Copy into your project's `.cursor/rules/` |
| Windsurf | Rules | `.windsurf/rules/applink.md` | Copy into your project's `.windsurf/rules/` |
| Cline | Rules | `.clinerules/applink.md` | Copy into your project's `.clinerules/` |
| Kiro | Rules | `.kiro/steering/applink.md` | Copy to `~/.kiro/steering/` or the project's `.kiro/steering/` |
...
├── .cursor/rules/applink.mdc     ← generated (with .mdc frontmatter)
├── .windsurf/rules/applink.md    ← generated
├── .clinerules/applink.md        ← generated
├── .kiro/steering/applink.md     ← generated
├── .qoder/rules/applink.md       ← generated
├── .agents/rules/applink.md      ← generated
...
```bash
node tools/applink.mjs show caas-otp-generation
node tools/applink.mjs curl caas-otp-generation
node tools/applink.mjs code P1003
```
